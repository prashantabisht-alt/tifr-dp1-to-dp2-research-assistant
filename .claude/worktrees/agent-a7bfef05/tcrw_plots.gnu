...
# ============================================================
# Plot 1: MSD vs t — achiral and chiral comparison
# ============================================================
set output "tcrw_plot_MSD.png"
set xlabel "t (steps)"
set ylabel "MSD(t)"
...
# ============================================================
# Plot 2: D(omega) — diffusion coefficient vs chirality
# ============================================================
set output "tcrw_plot_D_vs_omega.png"
set xlabel "{/Symbol w}"
set ylabel "D_{eff}"
...
# ============================================================
set output "tcrw_plot_trajectory.png"
set xlabel "x"
set ylabel "y"
...
plot "tcrw_trajectory.dat" u 2:3 w l lw 0.5 lc rgb "#4393c3" title ""

unset size

# ============================================================
# Plot 4: OBC steady-state density P(x,y) — heatmap
# ============================================================
set output "tcrw_plot_density.png"
set xlabel "x"
set ylabel "y"
...
splot "tcrw_obc_visits.dat" u 1:2:3 w pm3d title ""

unset view
unset pm3d

# ============================================================
# Plot 5: OBC current field J(x,y) — vector plot
# ============================================================
set output "tcrw_plot_currents.png"
set xlabel "x"
set ylabel "y"
...
plot "tcrw_obc_currents.dat" u 1:2:(scale*$3):(scale*$4) w vectors \
     head size 0.3,20 filled lw 1.5 lc rgb "#1a9850" title ""
