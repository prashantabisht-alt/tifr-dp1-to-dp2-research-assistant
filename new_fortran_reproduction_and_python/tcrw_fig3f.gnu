...
# explicit ytic positions inside [150:400]
set ytics ( "150" 150, "200" 200, "250" 250, "300" 300, "350" 350, "400" 400 )
set mytics 5
set xtics 0, 0.1, 1.0
set mxtics 2
set tics scale 0.8
...
# CONVENTION (after Fortran rerun): col 1 = L_paper (paper-style legend),
# matching `L_list = (9, 19, 49)` in tcrw_fig3f.f90.  Sim runs at L_cur =
# L_paper + 1.  Filter MUST match what current source writes (L_paper).
# col 2 = ω, col 3 = ratio.
# NOTE: existing tcrw_fig3f_summary.txt was generated by an older source
# version that wrote L_cur (10, 19, 49) — re-run `./tcrw_fig3f` first.
plot_cmd = \
