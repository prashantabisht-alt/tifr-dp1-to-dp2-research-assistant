...
# matching `L_list = (9, 19, 49)` in tcrw_fig3g.f90.  Sim runs at L_cur =
# L_paper + 1.
# col 2 = ω, col 3 = ratio
# NOTE: existing tcrw_fig3g_summary.txt was generated by an older source
# version that wrote L_cur (10, 19, 49) — re-run `./tcrw_fig3g` first.
plot_cmd = \
